...
public class RssFeed {
	...
	private SplitRssItemValue splitRssItemValue;

	public RssFeed() {
		rssItemsList = new ArrayList<HashMap<String, Object>>();
		splitRssItemValue = new SplitRssItemValue();
	}

	public void addItem(RssItem rssItem) {
		splitRssItemValue.splitItemTitleInfo(isAlertsItem(rssItem.getItem_author()), rssItem.getItem_title());
