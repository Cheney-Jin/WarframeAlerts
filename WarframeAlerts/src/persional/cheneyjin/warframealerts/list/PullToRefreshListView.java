...
public class PullToRefreshListView extends ListView {
	...
	private void init() {
		...
		lastUpdatedTextView.setTextColor(Color.WHITE);
		...
		reverseFlipAnimation = new RotateAnimation(-180, 0, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
	...
	private void bounceBackHeader() {
		...
		TranslateAnimation bounceAnimation = new TranslateAnimation(Animation.ABSOLUTE, 0, Animation.ABSOLUTE, 0, Animation.ABSOLUTE, 0, Animation.ABSOLUTE, yTranslate);
