...
public class Constants {
	...
	//public static final String 	WARFRAME_RSS_PC_URL 			= "http://10.16.0.17:8095/rss/rss.php";
	...
	//public static final String 	TEST_RSS 						= "http://10.16.0.17:8095/rss/rss.php";
		
	public static String RSS_PLATFORM							= "";
	
	public static String getRssUrl(String alertsType){
		String url = "";
		if(alertsType.equals(Constants.WARFRAME_ALERTS_PLATFORM_PS4)) url = Constants.WARFRAME_RSS_PS4_URL;
		else if(alertsType.equals(Constants.WARFRAME_ALERTS_PLATFORM_PC)) url = Constants.WARFRAME_RSS_PC_URL;
		else if(alertsType.equals(Constants.WARFRAME_ALERTS_PLATFORM_XBOX)) url = Constants.WARFRAME_RSS_XBOX_URL;
		else url = null;
		return url;
	}
}
